...
COSS 주최 2025 SDGs 기반 사회문제 해결 경진대회 대상 수상작
...
ESP32 RSSI 기반 거리 판단 + 장치 내장 LED/진동/LCD 표시를 통해 **소음 없이 자연스럽게 양보를 유도**합니다.
...
- **Software**: C/C++ (Arduino), RSSI 기반 거리 추정 알고리즘, Wi-Fi 브로드캐스트 통신  
